...
import { createManyTestContacts, createTestAddress, createTestContact, createTestUser, getTestAddress, getTestContact, removeAllTestAddresses, removeAllTestContacts, removeTestUser } from "./test-util.js";
...
describe('POST /api/contacts/:contactId/addresses', function(){
    ...
    it('should can create new address', async function(){
        ...
        expect(result.body.data.street).toBe("jln test");
    ...
    it('should reject if address request is invalid', async function(){
        const testContact = await getTestContact();
